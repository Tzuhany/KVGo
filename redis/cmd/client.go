...
type cmdHandler func(cli *KVGoClient, args [][]byte) (interface{}, error)
...
func set(cli *KVGoClient, args [][]byte) (interface{}, error) {
	if len(args) != 2 {
...
func get(cli *KVGoClient, args [][]byte) (interface{}, error) {
	if len(args) != 1 {
...
func hset(cli *KVGoClient, args [][]byte) (interface{}, error) {
	if len(args) != 3 {
...
func sadd(cli *KVGoClient, args [][]byte) (interface{}, error) {
	if len(args) != 2 {
...
func lpush(cli *KVGoClient, args [][]byte) (interface{}, error) {
	if len(args) != 2 {
...
func zadd(cli *KVGoClient, args [][]byte) (interface{}, error) {
	if len(args) != 3 {
